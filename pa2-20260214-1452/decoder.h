 ...
 * @file decoder.h
 * @author CPSC 221
 * @description Declarations for PA2, Decoder class
**/
...
private:
    ...
    /**
     * Tests a neighbour (adjacent vertex) to see if it is 
    ...
    **/
     ...
     * does not pay any attention to whether or not the neighbours are 
    ...
    **/
    ...
    /*************************************************************
    * IF YOU WISH TO DEFINE ADDITIONAL PRIVATE HELPER FUNCTIONS, *
    * ADD THEM TO decoder-private.h                              *
    *************************************************************/
    #include "decoder-private.h"
